...
| Status | Existing worksheet repaired in place; 3 records preserved; view and Leads loss flow tested. **Manual navigation move remains** |
...
- The MCP move call did not change the rendered sidebar. Move **Lost Reasons** under CRM › Configuration manually.
