...
| 13 | Stages | `crm.stage` | **Phase 2 CRM.** Existing worksheet repaired; 4 source stages preserved; Leads relation and pipeline grouping tested. Manual move to Configuration remains | [md](worksheets/13-stages.md) |
| 14 | Lost Reasons | `crm.lost.reason` | **Phase 2 CRM.** Existing worksheet repaired; 3 source reasons preserved; Lost action tested end to end. Manual move to Configuration remains | [md](worksheets/14-lost-reasons.md) |
| 15 | Recurring Plans | `crm.recurring.plan` | **Phase 2 CRM.** Empty placeholder replaced with the real 4-field model; 0 records. Source feature is disabled, so manual sidebar hiding remains | [md](worksheets/15-recurring-plans.md) |
| 16 | Leads | `crm.lead` | **Phase 2 CRM.** Built with native relations, 3 views, conditional Lost Reason, Won/Lost actions and published workflows; core CLI/MCP and rendered checks pass. Fresh-form Stage default, dynamic current-user view filter and related-tag colour remain open | [md](worksheets/16-leads.md) |
